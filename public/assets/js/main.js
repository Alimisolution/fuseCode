(function ($) {
  ...
  document
    .querySelectorAll(".eu_header_nav_menu ul > li > a")
    .forEach(
      (button) =>
        (button.innerHTML =
  ...
  let TitleContainer = new SplitText(".tp_title_anim", {
    type: "chars, words",
  });
  ...
  let descriptionContainer = new SplitText(".tp_desc_anim", {
    type: "chars, words",
  });
...
============================================================================= */
  ...
  $(".zq_mobile_menu .close-menu, .one-scroll .menu-navbar .main-menu > li").on(
    "click",
    function () {
      $(".zq_mobile_menu")
        .removeClass("open")
  ...
  $(".zq_mobile_menu .menu-navbar .main-menu > li").on(
    "mouseenter",
    function () {
